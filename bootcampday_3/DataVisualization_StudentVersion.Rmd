...
Coolors (fun website for generating color palettes): https://coolors.co 
...
rm(colorPalette)
colorPalette <- rev(wesanderson::wes_palette('Royal2',n = 5))
colorPalette[1:5]
colorPalette <- c("#74A089", "#FDDDA0", "#F8AFA8", "#F5CDB4", "#9A8822")
# Generate scatter plot using theme
ggplot(randomData,aes(x = Age,y = Systolic.BP, color = AgeGroup)) + 
  geom_point() +
  geom_vline(xintercept = c(30, 40, 50, 60, 70), linetype = "dashed", color = colorPalette) +
  # Define colors 
  scale_color_manual(values = colorPalette) +
  # Change labels
  labs(x = 'Age (yrs)',y = 'Sytosolic Blood Pressure (mmHg)',color = 'Measure',
       title = "Mean Systolic Blood Pressure: 128.43 mmHg") +
  # Set theme
  newBlankTheme
